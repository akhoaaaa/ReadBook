    ...
    <div class="container">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{route('danh-muc',[$danhmuctruyen->slug])}}">{{$danhmuctruyen->tendanhmuc}}</a></li>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-3">
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        <img class="product__details__pic__item--large" src="{{asset('public/uploads/images/'.$truyen->hinhanh)}}" alt="">
                    </div>
            ...
            <div class="col-lg-9 col-md-9">
                <div class="product__details__text">
                    <h3 class="nametruyen">{{$truyen->tentruyen}}</h3>
                    <p><i>[Cập nhật lúc: {{ date_format(date_create($truyen->updated_at), ' H:i d/m/Y') }}]</i></p>
                    <div class="row">
                        ...
                        @endforeach
                        <strong>
                            <span><i class="fa fa-book"></i>{{$tongchap}} CHAP</span>
                        </strong>
                        <strong>
            ...
            <div class="col-lg-12">
                <div class="product__details__tab">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" data-toggle="tab" href="#tabs-1" role="tab" aria-selected="true">Tóm tắt truyện</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#tabs-2" role="tab" aria-selected="false">Mục lục</a>
                        </li>
                        <!-- <li class="nav-item">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6">
                <div class="product__item">
                    <div class="product__item__pic set-bg" data-setbg="{{asset('public/uploads/images/'.$cungdanhmuc->hinhanh)}}">
