...
class IndexController extends Controller
{
    public function home(){
        $truyen = Truyen::orderBy('id','DESC')->where('kichhoat',1)->paginate(8);
        return view('pages.home')->with(compact('truyen'));
    }
    public function danhmuc($slug){
        ...
        return view('pages.danhmuc')->with(compact('truyen','danhmuctruyen'));
    }
    ...
    public function truyentranh($slug){
        ...
        return view('pages.truyen')->with(compact('truyen','danhmuctruyen','chapter','cungDanhMuc','chapter_dau'));
    }
