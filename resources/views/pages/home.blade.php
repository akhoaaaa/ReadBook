                ...
                <div class="categories__slider owl-carousel">
                    <div class="col-lg-3">
                        <div class="categories__item set-bg"
                             data-setbg="{{asset('public/uploads/images/usericon-21.png')}}">
                            <h5><a href="#">Truyện kinh dị</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg"
                             data-setbg="{{asset('public/uploads/images/usericon-21.png')}}">
                            <h5><a href="#">Truyện ma</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg"
                             data-setbg="{{asset('public/uploads/images/usericon-21.png')}}">
                            <h5><a href="#">Truyện trinh thám</a></h5>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="categories__item set-bg"
                ...
                <div class="col-lg-3 col-md-4 col-sm-6 mix oranges fresh-meat">
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg"
                             data-setbg="{{asset('public/uploads/images/'.$tr->hinhanh)}}">
